...
<!-- Styles: flex container + cards, uses Quarto/Bootstrap CSS vars -->
<style>
  .repo-grid {
    display: flex;
    flex-wrap: wrap;
...
<div class="repo-grid-container">
  <h2 class="anchored"><a href="https://github.com/saforem2/"><code>saforem2</code></a>s GitHub Repositories</h2>
  <p class="repo-grid-loading" id="repo-grid-status">
    Loading repositories from GitHub…
  </p>
  <div id="repo-grid"
       class="repo-grid"
       data-github-user="saforem2">
  </div>
</div>
