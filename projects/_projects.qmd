::: {.callout-tip icon=false aria-label="GitHub Stats" title='[📊 GitHub Stats]{.dim-text-11}' collapse="false" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.3)!important; opacity:100%;"}
...
::: {.callout-tip icon=false aria-label="GitHub Repos" title='[📂 [`saforem2/`](https://github.com/saforem2?tab=repositories)]{.dim-text-11}' collapse="false" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.3)!important; opacity:100%;"}
