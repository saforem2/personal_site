...
Figure 22: Tensor Parallel GEMM. This information is based on (the much
more in-depth) [TP
...
Figure 23: Figure taken from [3D parallelism: Scaling to
trillion-parameter
...
Figure 24: Large Language Models have (LLM)s have taken the ~~NLP
...
Figure 25: [Emergent abilities of Large Language
...
Figure 26: Visualization from Yang et al. (2023)
...
Figure 27: It’s hungry! Wei et al. (2022)
...
Figure 28: **Pre-training**: Virtually *all of the compute* used during
pre-training[^4].
...
Figure 29: **Fine-tuning**: Fine-tuning actually updates the model’s
...
Figure 30: Language Model trained for causal language modeling[^6].
...
Figure 31: Language Model trained for causal language modeling[^7].
...
Figure 34: The simplest, fastest repository for training / finetuning
GPT based models.
...
Figure 35: Example: Training a LLM to talk like Shakespeare using
