...
- Best practice:
  - Use conda to install a fixed python version
    - Install *frameworks* and packages that you anticipate sharing
      across projects (e.g. `torch`, `numpy`, `matplotlib`, …)
    - Distribute
