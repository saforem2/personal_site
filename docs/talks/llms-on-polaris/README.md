...
- There are two nodes per chassis, seven chassis per rack, and 40 racks
...
- Additional information in our [user
...
- To install a **different** version of a package that is already
...
Figure 9: 3D Parallelism illustration. Figure from:
...
- Link[^8] to [video](https://asciinema.org/a/668462)
...
[^7]: [Efficient Large-Scale Language Model Training on GPU
    Clusters](https://arxiv.org/abs/2104.04473)

[^8]: idk why it doesn’t render correctly in the slide (seems like
    refreshing helps?)
