...
- [📌 Source Repositories](#pushpin-source-repositories)
- [🏃‍♂️ Running](#running_man-running)

## 📌 Source Repositories

Things are changing *quickly*, so to avoid confusion, here are the exact
branches used for this demo:

- Using:
  - [auroraGPT-ANL/`torchtitan` @
    saforem2/blendcorpus](https://github.com/auroraGPT-ANL/torchtitan/tree/saforem2/blendcorpus)
  - [saforem2/`blendcorpus` @
    saforem2/reorg-imports](https://github.com/saforem2/blendcorpus/tree/saforem2/reorg-imports)[^1]
...
- Launch:
  ...
  [W912 11:37:15.852098275 OperatorEntry.cpp:218] Warning: Warning only once for all operators,  other operators may also be overridden.
