...
::: {.callout-tip icon=false aria-title="Now Playing" title='[![](/assets/spotify-green.svg){.ineline-icon style="height:1em;"} Now Playing]{style="color:#1CD760; margin:auto; padding: 1pt;"}' collapse="true" style='border: none!important; background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important; margin-top: -0.25em;'}
