...
::: {.callout-tip icon=false aria-label="Now Playing" title='[![](/assets/spotify-green.svg){.inline-icon style="height:1.25rem;vertical-align:text-bottom;"} Now Playing]{style="color:#1CD760;"}' collapse="true" style="width:100%; border: 1px solid rgba(28, 215, 96, 0.25)!important; background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important; opacity: 100%; &:hover {background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important;}"}
