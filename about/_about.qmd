...
::: {.callout-tip icon=false title='🎤 [Recent Talks]{.dim-text}' collapse="false" style="text-align: left!important; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.0); width: 100%; opacity:100%;"}
[\[[here](talks/index.qmd)\] ( \+ how I [make them](./posts/dope-slides/index.qmd)! )]{.dim-text style="font-size:1em;"}
:::

::: {.callout-tip icon=false aria-label="Now Playing" title='[<img aria-label="Spotify" src="./assets/spotify-green.svg" class="inline-icon img-fluid" height="24" width="24" style="height:1.25rem; width: auto; vertical-align:text-top;" alt="spotify" /> Now Playing]{style="color:#1CD760;"}' collapse="true" style="width:100%; border: 1px solid rgba(28, 215, 96, 0.25)!important; background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important; opacity: 100%; &:hover {background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important;}"}
...
::: {.callout-tip collapse="true" icon=false aria-label="last.fm" title='<a href="https://last.fm/user/saforem2" target="_blank"><img src="https://api.iconify.design/logos:lastfm.svg" aria-label="last.fm/user/saforem2" alt="last.fm" style="overflow: visible;"/></a>' collapse="true" style='border: none!important; border: 1px solid rgba(212, 17, 9, 0.25)!important; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: 100%!important;'}

<!-- <a href="https://last.fm/user/saforem2" target="_blank"><img src="https://api.iconify.design/logos:lastfm.svg?color=%23888888" alt="last.fm" style="height:1.25rem; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important;margin-top: 0.5rem;"></a> -->

<!-- [<img src="https://api.iconify.design/logos:lastfm.svg?color=%23888888" alt="last.fm" style="height:1.25rem; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important;margin-top: 0.5rem;"> last.fm]{style="color:#D41109;"} -->

<!-- [![last.fm](https://api.iconify.design/logos:lastfm.svg?color=%23888888)](https://last.fm/user/saforem2) -->
<!-- <a href="https://www.last.fm/user/saforem2"><iconify-icon loading="lazy" role="img" inline="true" icon="logos:lastfm" aria-label="LastFM" title="LastFM" style="scale:99%"></iconify-icon></a> -->

<!-- <a href="https://last.fm/user/saforem2" target="_blank"><img src="https://api.iconify.design/logos:lastfm.svg?color=%23888888" alt="last.fm" style="height:1.25rem; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important;margin-top: 0.5rem;"></a>[<img src="https://api.iconify.design/logos:lastfm.svg?color=%23888888" alt="last.fm" style="height:1.25rem; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important;margin-top: 0.5rem;"> last.fm]{style="color:#D41109;"}[![last.fm](https://api.iconify.design/logos:lastfm.svg?color=%23888888)](https://last.fm/user/saforem2) -->
<!-- [ -->
<!-- ![https://last.fm/user/saforem2](https://api.iconify.design/logos:lastfm.svg?color=%23888888)](https://last.fm/user/saforem2) -->
<!-- ]{style="color:#D41109;"}' collapse="true" style='border: none!important; border: 1px solid rgba(212, 17, 9, 0.25)!important; background-color: oklch(from #D41109 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: 100%!important;'} -->
