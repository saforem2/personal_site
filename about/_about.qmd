...
::: {.callout-tip icon=false aria-title="Recent Talks" title='🎤 [Recent Talks]{.dim-text style="font-size:1.0em!important;"}' collapse="false" style="text-align: left!important; width: 100%; background-color:rgba(131,131,131,0.05)!important; margin-top: -1em; opacity:100%;"}
[📊 [here](talks/index.qmd) ( \+ how I [make them](./posts/dope-slides/index.qmd)! )]{.dim-text style="font-size:1em;"}
:::

::: {.callout-tip icon=false aria-title="Now Playing" title='[![](/assets/spotify-green.svg){.inline-icon style="height:1.125rem; vertical-align: text-bottom;"} Now Playing]{style="color:#1CD760; margin:auto; padding: 1pt;"}' collapse="true" style='background-color: oklch(from #1CD760 calc(l * 1.15) c h / 0.11)!important; opacity: 100% width: -webkit-fill-available!important; margin-top: -0.1em;'}
