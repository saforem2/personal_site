...
::: {.callout-tip collapse=true icon=false title="Headings"}
...
<img src="/assets/nvim-headings-light.png" alt="Light Theme" width="49%" style="display:inline-block;"> <img src="/assets/nvim-headings-dark.png" alt="Dark Theme" width="49%" style="display:inline-block;">
<!-- ![Light Theme](/assets/nvim-headings-light.png){width="49%"} ![Dark Theme](/assets/nvim-headings-dark.png){width="49%"} -->
