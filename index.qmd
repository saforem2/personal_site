...
::: {.callout-tip icon=false aria-title="✏️ Status" title='[👀 More]{.dim-text}' collapse="true" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.0); opacity:100%; margin-block-start: 0.5rem;"}
