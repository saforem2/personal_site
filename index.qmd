...
::: {style="font-size:1.0em; text-align: center; margin-top: -5rem; " background-iframe="https://saforem2.github.io/grid-worms-animation/"}
...
<!--   <div class="text"> -->
<!--   sample text <br /> -->
<!--   more sample text here</div> -->
<!-- <iframe width="450" height="850" src="https://saforem2.github.io/grid-worms-animation/" title="W3Schools Free Online Web Tutorials"> -->
<!-- </iframe> -->
<!--    -->
<!-- </div> -->

[![](./assets/avatar.png)]{.profile-avatar style="width: 100%;margin-top: -2rem;"}  
[[![](https://readme-typing-svg.demolab.com?font=IBM+Plex+Sans+Condensed&weight=700&size=32&duration=2500&pause=1000&color=838383&vCenter=true&random=true&width=210&lines=%F0%9F%91%8B+Hi%2C+I'm+Sam!)](https://git.io/typing-svg) [[{{< ai orcid >}}]{.orcid-green}](https://orcid.org/0000-0002-9981-0876)]{style="font-size: 1.875rem; color: var(--dim-text)!important; font-weight: bold; margin-bottom: -0.75rem; letter-spacing:-1px;"}  
...
[[{{< iconify line-md email-opened-twotone-alt >}}](mailto:///foremans@anl.gov)]{style="font-size:1.5rem; padding-left: 0.075rem; padding-right: 0.075rem"}
[[{{< iconify line-md coffee-twotone-loop >}}](https://scholar.google.com/citations?user=vV_1zDwAAAAJ&hl=en)]{style="font-size:1.5rem; padding-left: 0.075rem; padding-right: 0.075rem"}
<!-- [[{{< ai orcid >}}](https://orcid.org/0000-0002-9981-0876)]{style="font-size:1.5rem; padding-left: 0.075rem; padding-right: 0.075rem"} -->
...
<!-- [[{{< iconify line-md instagram >}}](https://www.instagram.com/saforem2)]{style="font-size:1.5rem; padding-left: 0.075rem; padding-right: 0.075rem"} -->
