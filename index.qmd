...
::: {.callout-tip icon=false aria-title="Recent Talks" title='🎤 [Recent Talks]{.dim-text}' collapse="false" style="text-align: left!important; width:100%; border: none!important; border-left: 1.5px solid var(--dim-text)!important; border-radius: 0pt!important; background-color: var(--code-bg); opacity:100%;"}
