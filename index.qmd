...
::: {.callout-tip icon=false collapse="false" style="text-align: left!important; width:100%; border: none!important; border-left: 2px solid var(--dim-text)!important; border-radius: 0pt!important; background-color: var(--bg-transparent); opacity:100%;" title='[![](https://api.iconify.design/twemoji:speaking-head.svg?color=%23888888) Recent Talks]{.dim-text}'}
...
::: {.callout-tip icon=false collapse="true" style='width:100%; border: none!important; border-left: 2px solid #1ED760!important; border-radius: 0pt!important; opacity: 100%;' title='[![](https://api.iconify.design/logos:spotify-icon.svg?color=%23888888) Now Playing:]{style="color:#1ED760;"}'}
