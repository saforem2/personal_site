...
<!-- - 🧪 AI / ML + HPC _for science[^disciplines]_! -->
<!-- - 🧪 Interested in {AI, HPC} for {LatticeQCD, Protein Generation, Weather Forecasting / Climate Modeling, Generative Modeling, Drug Discovery, ...} !! -->
