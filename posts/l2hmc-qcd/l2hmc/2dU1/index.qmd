...
title: "🎢 <code>l2hmc-qcd</code> Example: 2D U(1)"
date: 2023-12-14
# author:
...
#    type: webpage
#    title: "2D $U(1)$ Model"
#    url: https://samforeman.me/posts/l2hmc-qcd/2d-U1
# citation:
#    author: Sam Foreman
#    type: webpage
...
<div class="cell-output output stream stdout">
...
<div class="cell-output output stream stderr">
...
<div class="cell-output output display_data">
...
<div class="cell-output output execute_result" execution_count="5">
...
<div class="cell-output output execute_result" execution_count="7">
