...
::: {.column-body-outset style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;"}
...
<!--
::: {.callout-note icon=false title="📑 W&B Report" style="background-color: oklch(from var(#4582ec) calc(l * 1.15) c h / 0.1);"}
