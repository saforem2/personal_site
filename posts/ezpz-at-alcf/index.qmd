...
> and are all prefixed with `ezpz_`
>
...
1. `ezpz_setup_python`: This is done in two parts.
   ...
   1. `ezpz_setup_conda`: Will first attempt to load and activate a suitable
      ...
      Depending on where we're running from, this will behave slightly differently:
   ...
   2. `ezpz_setup_venv`: Ideally, we are now inside a suitable `conda` environment.
...
<details closed><summary><b>Old <code>README</code>s</b></summary>

<details closed><summary><code>README</code> (old)</summary>
