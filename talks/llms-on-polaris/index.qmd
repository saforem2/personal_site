...
subtitle: "Overview of Large Language Models and Training on Polaris"
description: "Presented at the [Center for Foundation Models and AI Agents for Science 2024](https://scifm.ai/summer_school.html)"
...
citation:
  author: Sam Foreman
  type: speech
  genre: "Presentation at the SciFM Summer School 2024"
...
format:
  revealjs:
    ...
    center: true
    shift-heading-by: -1
    footer: "[samforeman.me/talks/llms-on-polaris/slides](https://samforeman.me/talks/llms-on-polaris/slides)"
    slide-url: samforeman.me/talks/llms-on-polaris/slides
    # width: 1280
    # height: 720
    # css:
...
## 👤 [Sam Foreman](https://samforeman.me) {.smaller background-color="white"}
...
: Polaris A100 GPU Information {.responsive .striped .hover}
...
## Recent Work (2017 -- Now) {.smaller background-color="white"}

::: {style="font-size: 0.9em; max-height: 30lh; overflow: auto;"}
...
## Life-Cycle of the LLM: Fine-Tuning {auto-animate=true .smaller background-color="white"}
...
<video loading="lazy" style="max-width:500pt" data-autoplay src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/assisted-generation/gif_1_1080p.mov"></video>
...
## Parallelism Concepts {.smaller background-color="white"}
...
## Parallelism Concepts[^hf-mp1] {.smaller background-color="white"}
...
## Data Parallelism {.smaller background-color="white"}
...
## Tensor Parallelism {.smaller background-color="white"}
...
## 3D Parallelism {.smaller background-color="white"}
