...
::: {.flex-container style="align-items: center; text-align: center; max-width: 80%;"}

![`3.5B` Model](./assets/mprot-3p5B-scaling-2.svg){#fig-mprot-3p5B-scaling1 style="text-align:center;"}

:::

## 🕸️ Generative AI for Dynamic Graphs {background-color="white"}
