---
title: "AERIS"
subtitle: "Argonne's Earth Systems Model"
...
::: {.flex-child #fig-arxiv style="width:150%;"}
...
![](./assets/cover2.svg){.light-content width="80%"}

![](./assets/cover1.svg){.dark-content width="80%"}
:::

::: {.content-visible when-format="revealjs" style="margin-left: auto; margin-right: auto;"}
![](./assets/cover2.svg){.light-content width="80%"}
:::
...
![](./assets/science/s2s.png){width="90%"}
