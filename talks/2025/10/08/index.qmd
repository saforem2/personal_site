...
subtitle: "for Reliable and Skillful Predictions"
...
![](./assets/cover2.svg){.light-content}

![](./assets/cover1.svg){.dark-content}
:::
...
## Contributions {.smaller background-color="white"}
...
- Medium-range forecast skill
  - Surpasses IFS ENS, competitive with GenCast
    (@price2024gencastdiffusionbasedensembleforecasting)
  - Uniquely stable on seasonal scales to 90 days

<!--
  , validated through
    domain-specific diagnostics and case studies of hurricanes and heatwaves.
-->

[^amd]: Using AMD MI250x GPUs, see:
    [GPU nodes - LUMI-G](https://docs.lumi-supercomputer.eu/hardware/lumig/)
