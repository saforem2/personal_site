...
::: {.callout-important icon=false title="🌎 [AERIS]{style='color:var(--green-text)!important'}" style="background-color: oklch(from var(--green-text) calc(l * 1.15) c h/0.1)!important;"}
