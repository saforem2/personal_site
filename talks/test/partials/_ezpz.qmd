# 🍋 [`ezpz`](https://github.com/saforem2/ezpz) {.centeredslide height="100%" background-color="#FFF"}

## Clone Repo(s) {background-color="#FFF"}
...
## Setup Python {.scrollable}  {background-color="#FFF"}
...
## Install `{ezpz, wordplay}` {.scrollable background-color="#FFF"}
...
## Launch [`ezpz.test_dist`](https://github.com/saforem2/ezpz/blob/main/src/ezpz/test_dist.py) {.scrollable background-color="#FFF"}
...
## PyInstrument Profile  {background-color="#FFF"}
...
## Example: [`ezpz` 🍋](https://github.com/saforem2/ezpz) {.centeredslide height="100%"}
