...
format:
  ...
  revealjs:
    ...
    width: 1024
    height: 768
    presentation-font-size-root: 32pt
    max-scale: 4.0
    min-scale: 0.1
...
## 🛠️ Hands On: Getting Started {background-color="white"}
...
1. Test distributed setup:
    ...
    See: [`ezpz/test_dist`](https://github.com/saforem2/ezpz/blob/main/src/ezpz/test_dist.py)
