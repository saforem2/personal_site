...
- Course:
  - 📂 [ALCF: Intro to AI-driven Science on Supercomputers](https://www.alcf.anl.gov/alcf-ai-science-training-series)
...
::: {#fig-ddp-training-mermaid .flex-container}
...
## Data Parallel Training: Forward Pass {background-color="white"}
...
## Data Parallel Training: Backward Pass {background-color="white"}

::: {#fig-ddp-training-broadcast}
...
::: {#fig-allgather-mermaid style="width:70%; text-align:center; margin-left: auto; margin-right: auto;"}
...
# Additional Parallelism Strategies {background-color="white"}
...
- **Pipeline Parallelism** (`PP`):
    ...
    - {{<iconify logos microsoft-icon >}} [DeepSpeed](https://deepspeed.readthedocs.io/en/latest/pipeline.html)
...
::: {#fig-tensor-parallel-example-mermaid}
