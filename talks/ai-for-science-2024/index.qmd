...
location: "[Intro to AI-for-Science on Supercomputers](https://www.alcf.anl.gov/alcf-ai-science-training-series)"
...
classDef purple fill:#FFCBE6,stroke:#333,stroke-width:1px,color:#000
classDef block fill:#CCCCCC02,stroke:#838383,stroke-width:1px,color:#838383
[class](2025-09-18_class.md) G0,G1, block
class a0,a1 red
class b0,b1 green
class c0,c1 blue
class d0,d1 yellow
...
::: {#fig-pretrain-two .column style="width:50%;"}
...
::: {#fig-finetune-lifecycle .column style="width:50%;"}
...
::: {.flex-container .scrollable style="max-height: 400px;"}
