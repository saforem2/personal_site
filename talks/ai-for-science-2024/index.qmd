...
::: {#fig-avgGrads style="max-width: 80%;"}
...
::: {#fig-allgather-mermaid style="width:66%; text-align:center; margin-left: auto; margin-right: auto;"}
...
::: {.flex-container style="align-items: flex-end;width: 100%;"}
