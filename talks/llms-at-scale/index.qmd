...
[Training LLMs]{style="color:#333333; font-size:1.5em; font-weight: 600; padding-bottom: 0.5rem;"}  
[(at Scale)]{style="color:#444444; font-size:1.45em; font-weight: 500;"}  
...
:::
[[samforeman.me/talks/llms-at-scale]{style="color:#137af5!important; background:oklch(from #137af5 calc(l * 1.15) c h / 0.085); border:0px solid #137af5!important; border-radius: 0.25rem;"}](https://samforeman.me/talks/llms-at-scale)  
:::
...
<!-- {{< include partials/_applications.qmd >}} -->
<!-- {{< include partials/_parallel_training_techniques.qmd >}} -->
<!-- {{< include partials/_scaling.qmd >}} -->
<!-- {{< include partials/_data_parallel.qmd >}} -->
<!-- {{< include partials/_model_parallel.qmd >}} -->
