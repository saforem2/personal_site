...
> _Modern parallelism techniques enable the training of large language models_

[See my slides on [Parallel Training Techniques](https://saforem2.github.io/parallel-training-slides) for additional details]{.dim-text}
