...
## [`wordplay` 🎮💬](https://github.com/saforem2/wordplay) {.centeredslide backgound-color="white"}

- Link[^wordplay-video] to [video](https://asciinema.org/a/668462)

<script src="https://asciinema.org/a/668462.js" id="asciicast-668462" async="true" style="max-height: 650px!important;"></script>
