# AI 🤝 Compute {.centeredslide height="100%" background-color="#FFFFFF"}

::: {#fig-ai-and-copute-all}
...
# AI 🤝 Compute \[Modern Era\] {.centeredslide height="100%" background-color="#FFFFFF"}

::: {#fig-ai-and-copute-modern}

![](./assets/ai-and-compute-modern-log.png){width="70%"}
...
# Single GPU Training {.centeredslide background-color="#FFFFFF"}
...
![Data Parallel Training](./assets/multi-gpu-ddp.drawio.svg){#fig-multi-gpu-ddp style="width:60%!important;"}
...
# Model Parallel Training: Example {background-color="#FFFFFF"}
