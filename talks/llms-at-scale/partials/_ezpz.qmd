...
## Example: [`ezpz` 🍋](https://github.com/saforem2/ezpz) {.centeredslide background-color="white"}

- Link[^ez-video] to [video](https://asciinema.org/a/668460)

<script src="https://asciinema.org/a/668460.js" id="asciicast-668460" async="true" style="max-height: 600px%!important;"></script>
