...
## AI 🤝 Compute \[Historical 2\] {.centeredslide .smaller background-color="white"}

::: {.flex-container}

::: {.col1 style="font-size: 0.85em; width:33%;"}
...
# Parallelism Concepts {.center .smaller background-color="white"}
...
## Tensor Parallelism {.center background-color="white"}
