# 🚀 Scaling: Overview  {background-color="#FFF"}
...
## AI 🤝 Compute \[Historical\] {.centeredslide .smaller height="100%" background-color="#FFF"}
...
# Parallelism Concepts {.centeredslide .smaller height="100%" style="height: 100%;"}

::: {.panel-tabset style="max-height: 100%;"}
...
## Data Parallel Training {.centeredslide background-color="#FFF" auto-animate=true style="height: 100%; max-height: 100%;"}
...
- Recent presentation on [🎬 _"Parallel Training Techniques"_](https://youtu.be/930yrXjNkgM)

![Data Parallelism](https://saforem2.github.io/distributed-training-slides/assets/avgGrads.svg){#fig-avgGrads}

## Deal with Data {background-color="#FFF"}
...
## Broadcast Initial State {background-color="#FFF"}
...
<!-- ## Data Parallel Training {background-color="#FFF" auto-animate=true} -->
<!---->
<!-- ::: {layout="[45,-5,50]"} -->
<!---->
<!-- ::: {.col1 style="font-size:0.75em;"} -->
...
## Best Practices {.smaller background-color="#FFF"}
...
## Why Distributed Training? {background-color="#FFF"}
...
## Recent Progress {background-color="#FFF"}
...
# Deciding on a Parallelism Strategy {background-color="#FFF"}
...
# Tensor (/ Model) Parallel Training: Example {background-color="#FFF"}
...
## Model Parallel Training {background-color="#FFF"}
