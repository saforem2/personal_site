...
# Parallelism Concepts {.centeredslide .smaller height="100%" style="height: 100%;" background-color="#FFF"}
...
# Data Parallelism {style="font-size: 0.9em;" background-color="#FFF"}

## Data Parallel Training {.centeredslide .smaller background-color="#FFF" auto-animate=true style="height: 100%; max-height: 100%;"}
...
## Deal with Data {background-color="#FFF" .smaller}
...
## Tensor (Model) Parallelism[^efficient-large-scale] {background-color="#FFF"}
...
## Tensor Parallelism {style="font-size: 0.9em;" background-color="#FFF"}
...
## 3D Parallelism {background-color="#FFF"}
