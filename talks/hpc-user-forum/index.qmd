...
## AuroraGPT{.smaller background-color="white"}
...
::: {.flex-container style="text-align: center; max-height: 100%; font-size: 0.8em;"}
...
## 📊 Fixing Data Bottlenecks {background-color="white"}
...
::: {.flex-container .center style="text-align:center; font-size: 75%; width: 90%"}
