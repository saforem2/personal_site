...
Large Language Models have (LLM)s have taken the ~~NLP community~~ **world** by storm
...
3. [**Models / Training**[^me]]{style="background: oklch(from #ff1a8f calc(l * 1.15) c h / 0.1); border: 1px solid #ff1a8f; border-radius: 0.25px;"}
...
## 🤖 Aurora: System Overview {background-color="white"}
...
## 🦜 Model Training {.centeredslide background-color="white"}
...
- This requires:
    ...
    - {network, filesystem, machine} stability

- For larger models:
    - Effective, performant parallelism strategies
...
::: {.callout-note icon=false title="🏦 Acks"}
...
## ℹ️ LLMs: Overview {background-color="white"}
