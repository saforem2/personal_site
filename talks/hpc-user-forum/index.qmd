...
[**Credit to the entire AuroraGPT team for slides**]{.center}
...
::: {#fig-project-goals style="vertical-align:center;"}
...
- **International Collaborations** around the long term foal of _AGI for science_

## Aurora {.smaller background-color="white"}
...
ALCF AI Testbed Systems are in production and [available for allocations](https://accounts.alcf.anl.gov/#/allocationRequests) to the research community

- [NAIRR Pilot](https://nairrpilot.org/)

::: {.flex-container style="height: -webkit-fill-available;"}

::: {#fig-sambanova style="height:120px;"}
...
::: {#fig-graphcore style="height:120px;"}
...
::: {#fig-cerebras  style="height:120px;"}
...
::: {#fig-groq style="height:120px;"}

![](./assets/groq.jpeg)

GroqRack - nine nodes, with eight GroqChip v1.5 Tensor streaming processors accelerators per node
:::
...
![Rick Stevens](./assets/team/rick-stevens.png){height="75pt"}  
Rick Stevens[^lead]
...
![](./assets/team/ian-foster.png){height="75pt"}  
Ian Foster

![](./assets/team/robert-underwood.png){height="75pt"}  
Robert Underwood
...
![](./assets/team/venkat-vishwanath.png){height="75pt"}  
Venkat Vishwanath

![](./assets/team/samforeman.png){height="75pt"}  
[Sam Foreman]{style="color: #ff1a8f; background-color: oklch(from #ff1a8f calc(l * 1.15) c h / 0.1);"}
...
![](./assets/team/franck-cappello.png){height="75pt"}  
Franck Cappello

![](./assets/team/sandeep-madireddy.png){height="75pt"}  
Sandeep Madireddy

![](./assets/team/bo-li.png){height="75pt"}  
Bo Li
...
![](./assets/team/rajeev-thakur.png){height="75pt"}  
Rajeev Thakur
...
![](./assets/team/charlie-catlett.png){height="75pt"}  
Charlie Catlett

![](./assets/team/david-martin.png){height="75pt"}  
David Martin
...
![](./assets/team/brad-ullrich.png){height="75pt"}  
Brad Ullrich
...
:::: {.flex-container .scrollable style="text-align: left; width: 100%; justify-content: space-around; line-height: 1em;"}
...
- Since training takes ~ weeks, want to be sure we're using the time wisely
...
::: {.flex-container style="font-size: 70%; flex-direction: column;"}
...
::: {.flex-container .center style="text-align:center; font-size: 75%; width: 88%; margin-left: auto; margin-right: auto;"}
...
## References  {.smaller background-color="white"}
