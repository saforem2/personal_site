...
### 📝 Pre-training 1 {background-color="white"}


::: {.col1 style="width:90%; text-align: center; margin-left: auto; margin-right: auto;"}
![**Pre-training**: Virtually all of the compute used during pretraining phase](https://jalammar.github.io/images/gpt3/03-gpt3-training-step-back-prop.gif)
:::

### 🎀 Fine-Tuning {background-color="white"}

::: {.col1 style="width:90%; text-align: center; margin-left: auto; margin-right: auto;"}
![**Fine-tuning**: Fine-tuning actually updates the model's weights to make the model better at a certain task.](https://jalammar.github.io/images/gpt3/10-gpt3-fine-tuning.gif)
:::
