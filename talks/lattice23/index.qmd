...
::: {.callout-note icon=false title="🥅 Goal" style="text-align:left;!important"}
...
::: {.callout-tip icon=false title="🪄 Trick" style="display:inline!important;"}
...
::: {.callout-tip icon=false title="🔋 Hamiltonian Dynamics"}
...
::: {.callout-note icon=false title="🐸 Leapfrog Step"}
...
::: {.callout-important icon=false title="⏳ Critical Slowing Down" style="text-align:left;"}
- $Q$ gets stuck!
...
<!-- ::: {.callout-tip icon=false aria-title="L2HMC Update" title='L2HMC Update' collapse="false" style="text-align: left!important; width: 100%; background-color:rgba(131,131,131,0.05)!important; background: rgba(131, 131, 131, 0.05)!important; border: 1px solid rgba(131,131,131,0.0)!important; margin-top: -1em; opacity:100%;"} -->
...
<!-- ::: {.callout-tip icon=false aria-title="🎲 Re-Sampling" title='🎲 Re-Sampling' collapse="false" style="text-align: left!important; width: 100%; background-color:rgba(131,131,131,0.05)!important; background: rgba(131, 131, 131, 0.05)!important; border: 1px solid rgba(131,131,131,0.0)!important; margin-top: -1em; opacity:100%;"} -->
<!-- ::: {.callout-tip icon=false aria-title="🎲 Re-Sampling" title='🎲 Re-Sampling' collapse="false" style="text-align: left!important; width: 100%; background-color:rgba(131,131,131,0.05)!important; background: rgba(131, 131, 131, 0.05)!important; border: 1px solid rgba(131,131,131,0.0)!important; margin-top: -1em; opacity:100%;"} -->
::: {style="border:1px solid red;"}
...
# 4D $SU(3)$ Model {#sec-su3 .centeredslide style="font-size: 0.9em;" background-color="#1c1c1c"}

:::: {.columns}

::: {.column width="50%"}

::: {.callout-note icon=false title="🔗 Link Variables" style="text-align:left;"}
...
::: {.callout-tip icon=false title="🏃‍♂️‍➡️ Conjugate Momenta" style="text-align:left;"}
...
::: {.callout-important icon=false title="🟥 Wilson Action" style="text-align:left;"}
