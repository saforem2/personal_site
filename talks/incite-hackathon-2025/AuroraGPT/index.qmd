...
::: {.column .green-card style="height:100%; margin:unset;"}
...
Results from [@mprot-dpo2024] ~ [4 EFLOPS]{.highlight-pink} @
38,400[^aggregate] XPUs on Aurora
...
![](./assets/mprot-3p5B-scaling-2.svg){width=80%}
...
[^aggregate]: 38,400 = 3200 x 12 (from the 12 XPU devices per node)

[^gb-finalist]: 🔔 Gordon Bell Finalist:
    [MProt-DPO](https://dl.acm.org/doi/10.1109/SC41406.2024.00013) [@mprot-dpo2024]
...
model sizes. Note: `EF(S)` -- sustained ExaFLOPS, `EF(P)` -- peak ExaFLOPS {.responsive .striped .hover}
