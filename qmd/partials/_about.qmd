...
::: {.callout-tip icon=false aria-title="last.fm" title='[[![](https://api.iconify.design/logos:lastfm.svg?color=%23888888)](https://last.fm/u/saforem2)]{style="color:#D41109; contain: content!important;"}' collapse="true" style='width:100%; font-size: 1.1em!important; border: none!important; border: 1px solid rgba(212, 17, 9, 0.3)!important; background-color: rgba(212, 17, 9, 0.075); margin-top: -0.1em; opacity: 100%;'}
