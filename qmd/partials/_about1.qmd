- 💻 Computational scientist at [Argonne National Laboratory](https://anl.gov) ([ALCF](https://alcf.anl.gov))

- 🧪 Interested in {AI, HPC} for science[^disciplines]

- 🚀 working on scaling large (language, vision, multi-modal) models_across
thousands of GPUs_[^yelling]
...
<!--   working on: -->
<!--     - scaling large {language, vision, multi-modal} models on [Aurora](https://www.alcf.anl.gov/aurora) -->
...
<!-- ::: {.callout-tip icon=false aria-title="Recent Talks" title='🎤 [Recent Talks]{.dim-text-11}' collapse="false" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.3)!important; opacity:100%;"} -->
<!-- You can get a live view of some of my recent talks [[here {{< iconify line-md external-link >}}](../qmd/talks/index.qmd)]{.bright-text} -->
<!-- ::: -->
<!---->
<!-- ::: {.callout-tip icon=false aria-title="Now Playing" title='[![](https://api.iconify.design/logos:spotify-icon.svg?color=%23888888) Now Playing:]{style="color:#1ED760; font-size:1.1em;"}' collapse="true" style='width:100%; border: none!important; border: 1px solid rgba(30, 215, 96, 0.5)!important; opacity: 100%;'} -->
<!---->
...
<!-- ::: -->
<!---->
<!-- ::: {.callout-tip icon=false aria-title="Now Playing" title='[[![](assets/lastfm.svg)]{style="display:inline;"} Now Playing:]{style="color:#D51007; font-size:1.1em;"}' collapse="true" style='width:100%; border: none!important; border: 1px solid rgba(213, 16, 7, 1.0, 0.5)!important; opacity: 100%;'} -->
<!---->
...
<!-- ::: {.callout-tip icon=false aria-title="Now Playing" title='[![](https://api.iconify.design/logos:spotify-icon.svg?color=%23888888) Now Playing:]{style="color:#1ED760; font-size:1.1em;"}' collapse="true" style='width:100%; border: none!important; border: 1px solid rgba(30, 215, 96, 0.5)!important;background-color: rgba(30, 215, 96, 0.05) opacity: 100%;'} -->
<!---->
<!-- <a href="https://www.last.fm/user/saforem2"><img src="https://lastfm-recently-played.vercel.app/api?user=saforem2" height="auto" width="350px"/></a> -->
<!---->
<!-- ::: -->
