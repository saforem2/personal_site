...
<!-- ::: {.callout-info title='[{{< iconify material-symbols attach-email-outline-rounded >}} Startup Times (Perlmutter)]{.dim-text}' collapse="True"} -->

::: {.callout-tip icon=false title='[{{< iconify material-symbols attach-email-outline-rounded >}} Application Startup Time]{.dim-text}' collapse="true" style="text-align: left!important; width:100%; border-color: var(--dim-color)!important; background-color: var(--bg-transparent); opacity:100%;"}
...
1. In [Startup Timing](#startup-timing),I provide a summary of how the
   startup time is identified
...
3. I discuss in [`ezpz`](#ezpz) a minimal example that can be used to measure
   the startup times.
...
::: {.callout-tip icon=false title='[{{< iconify octicon stopwatch-16 >}} Startup Times (Perlmutter)]{.dim-text}' collapse="true" style="text-align: left!important; width:100%; border-color: var(--dim-color)!important; background-color: var(--bg-transparent); opacity:100%;"}
