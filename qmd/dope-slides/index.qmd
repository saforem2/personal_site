...
- **`<span>`**'s: are created by wrapping text in square brackets, and will be treated as a `<span>`
with attributes if it is followed immediately by attributes, e.g.:
...
::: {#fig-overview .column width="60%" style="text-align:center;"}

![](./assets/overview.png)

[Overview Slide](https://saforem2.github.io/lattice23/#/overview)
...
[Markov Chain Monte Carlo](https://saforem2.github.io/lattice23/#/overview)
...
- In panel B we have a standard markdown image `![](./img.png)`
