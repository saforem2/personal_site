...
::: {.callout-tip icon=false aria-title="Recent Talks" title='🎤 [Recent Talks]{.dim-text}' collapse="false" style="text-align: left!important; width:100%; border: none!important; border-left: 0px solid var(--dim-text)!important; border-radius: 0pt!important; background-color: var(--code-bg); opacity:100%;"}
...
::: {.callout-tip icon=false aria-title="Now Playing" title='[![](https://api.iconify.design/logos:spotify-icon.svg?color=%23888888) Now Playing:]{style="color:#1ED760;"}' collapse="true" style='width:100%; border: none!important; border-left: 0px solid #1ED760!important; border-radius: 0pt!important; opacity: 100%;'}
